...
namespace AC
{
	...
	public class PlayerInteraction : MonoBehaviour
	{
		...
		private IEnumerator UseObject (int selectedItemID)
		{
			bool doRun = false;
			bool doSnap = false;
			if (KickStarter.playerInput.hotspotMovingTo == hotspot && KickStarter.playerInput.lastClickWasDouble)
			{
				if (KickStarter.playerInput.hotspotMovingTo.doubleClickingHotspot == DoubleClickingHotspot.TriggersInteractionInstantly)
				{
					doSnap = true;
				}
				else
